...
class AppLocalizationsPcm extends AppLocalizations {
  ...
  @override
  String get anxiety => 'Worry Worry';

  @override
  String get moodSwings => 'Mood Changes';
  ...
  String get article1Content =>
      'Pregnancy happen when sperm meet egg and baby settle comfortably. Understanding this go help you well well with your baby journey.';
  ...
  String get article2Content =>
      'Ovulation be when egg release from body. The egg go stay there for 12 to 24 hours and that be the only time baby fit come inside.';
  ...
  String get article3Content =>
      'If you dey try make baby but e no happen yet, remember this: infertility no be curse or punishment from anybody.';
