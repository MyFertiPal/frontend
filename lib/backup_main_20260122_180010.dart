...
import 'package:myfertipal/theme/app_theme.dart';
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ElevatedButton(
                                  onPressed: () =>
                                      provider.setLocaleByLanguageCode('en'),
                                  child: Text('English'),
                                ),
                                SizedBox(width: 10),
                                ElevatedButton(
                                  onPressed: () =>
                                      provider.setLocaleByLanguageCode('pt'),
                                  child: Text('Português'),
                                ),
                                SizedBox(width: 10),
                                ElevatedButton(
                                  onPressed: () =>
                                      provider.setLocaleByLanguageCode('yo'),
                                  child: Text('Yorùbá'),
                                ),
                              ],
                            ),
